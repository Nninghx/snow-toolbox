...
[![许可证](https://img.shields.io/badge/license-Apache%202.0-red.svg?logo=apache&label=%E8%AE%B8%E5%8F%AF%E8%AF%81)](Image\LICENSE.txt)
...
|V2.3.0|2026-5-11|界面优化（UI/UX Improvements）|1.主程序UI控件进行了重构<br>2.老版启动器V2.2.2和新版启动器V2.3.0版本<br>3.部分工具加入授权验证|
