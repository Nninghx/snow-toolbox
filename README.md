...
工具名称:|长度单位换算|数字大小写转换|空文件夹清理| 英文大小写转换| 字符频率分析器| 
...
工具名称:
多功能分数计算器模块|多功能代数计算器|三角函数计算器|多功能体积计算器|多功能数学和统计计算器|
多功能面积计算器|多功能表面积计算器|多功能周长计算器|
...
|V3.0.1|2026-5-17|1.紧急修复开发版本授权bug|
|V3.1.1|2026-5-17|1.项目自带的字体功能统一中。<br>2.项目的图标功能统一中。|
<<<<<<< HEAD
|V3.2.1|2026-5-20|1.新增文件夹或文件的时间修改器功能。<br>2.新增ModelScope 模型下载器|
=======
|V3.2.1|2026-5-18|1.新增文件夹或文件的时间修改器功能。<br>2.新增ModelScope 模型下载器|
|V3.3.1|2026-5-22|1.小游戏模块完成优化|
...
8.项目中存在一些子功能，没有在主程序中添加，是还没有测试过的，请勿使用。
>>>>>>> fc76869 (V3.3.1版本更新)
```
