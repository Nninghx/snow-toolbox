...
|V2.0.2|2025-7-16|性能优化（Performance Improvements）|1.主程序代码进一步缩减：通过移除重复的状态栏逻辑、优化工具检查流程等方式，显著提升了代码的可维护性。<br>2.代码体积减小：从 V2.0.0 的 24KB 缩减至当前版本的 18KB，提升加载效率与可维护性。|
