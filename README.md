...
| 分类 | 工具 |
|------|------|
| **PDF 工具** | PDF 拆分 · PDF 合并 · PDF 转 Word · PDF 加水印 · PDF 转图片 · 图片转 PDF |
...
1. 架构优化
新增 Core/Public base class.py，共用的窗口图标、授权验证及字体加载等方法至 PDFToolBase 基类。
2. Bug 修复
修复 PDF 合并功能中，添加文件后默认未选中页面导致合并结果为空的问题。
