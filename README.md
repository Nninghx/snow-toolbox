...
[![Platform](https://img.shields.io/badge/Platform-Windows%2011-0078D4?logo=windows)](https://www.microsoft.com/zh-hk/software-download/windows11)

> 宁幻雪 个人自用 Python 工具集合 —— 本地运行 · 免联网 · 零数据收集 · 隐私安全

## 项目简介

宁宝工具集是一款桌面工具箱应用，采用**主程序 + 分类子工具**的模块化架构。主启动器统一管理 10 大工具分类、53 个子工具（另含归档版本与报废淘汰归档），所有功能均在本地完成，不收集、不上传任何用户数据。
...
|分类|工具|进度|
|------|------|------|
|**PDF 工具**|PDF 拆分(已测试) · PDF 合并 · PDF 压缩 · PDF 转 Word · PDF 加水印 · PDF 转图片 · 图片转 PDF · PDF 合并为单页 · PDF 删除页面 · PDF 旋转 · PDF 反转页面 · OCR PDF · PDF 目录 · PDF 元数据 · PDF 自动改文件名 · PDF 损坏检测|更新中|
|**图片工具**|九宫格分割 · 格式转换 · ICO 转换 · 图片合成 · 批量裁剪|更新中|
|**音频工具**|视频音频提取|更新中|
|**文件工具**|目录树生成器 · 文件时间修改器 · 空文件夹清理|更新中|
|**其他工具**|数字小写转大写 · 长度单位换算 · 英文大小写转换 · 字符频率分析器 · 内存压缩管理 · VX 群聊消息发送|更新中|
|**B 站工具**|封面与表情包图片批量压缩 · 带货链接分批处理 · 商品链接 ID 提取|更新中|
|**计算器工具**|数学和统计 · 分数 · 代数 · 三角函数 · 二进制 · 体积 · 表面积 · 圆周率· 多边形周长计算器 · 多边形面积计算器|更新中|
|**小游戏**|24 点 · 数独 · 猜数字 · 2048 · 凹凸拼图|更新中|
|**下载工具**|HuggingFace 模型下载 · ModelScope 模型下载 · 图片下载|更新中|
|**生活辅助工具**|路线换乘工具|更新中|
|**归档版本**|PDF 拆分（V3 旧版） · PDF合并（V3 旧版）|保留归档|
|**废弃版本**|面积计算器 · 周长计算器|停止维护|
...
├── Life Assistance-V3/       # 生活辅助工具集
├── Archive version-V0/       # 归档版本
...
|版本|日期|内容|详细|
|------|------|------|------|
|V4.2.11+tools53|2026-09-20|1.调整优化部分子工具界面<br>2.新增部分音频子工具|无|
|V4.2.10+tools53|2026-09-13|1.新增大量PDF系列工具<br>2.调整打包方式(项目依然是开源状态)|无|
