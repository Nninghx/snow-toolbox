...
|分类|工具|进度|
|------|------|------|
|**PDF 工具**|PDF 拆分 · PDF 合并 · PDF 压缩 · PDF 转 Word · PDF 加水印 · PDF 转图片 · 图片转 PDF|已更新|
...
|版本|日期|内容|详细|
|------|------|------|------|
|V4.2.7+tools42|2026-08-30|1.新增遗留版本分支(旧版本的性能要优于新版本，妥妥的反向优化了，但不管新版本更新，但旧版本保留)2.优化了pdf拆分的界面优化|无|
|V4.2.6+tools42|2026-08-26|1.新增PDF压缩工具2.优化PDF系列工具运行效率3.+新增版本号后缀，tools42表示本发行包内含42个可用工具|无|
