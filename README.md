...
|2.1.0|2025-8-5|界面优化（UI/UX Improvements）<br>新功能（New Features）<br>项目重命名（Project rename）|1.调整主程序的UI界面<br>2.主程序新增游戏板块:24点小游戏，数独小游戏，猜数字小游戏<br>3.项目名称从三垣工具集改为幻雪工具<br>4.预添加项目添加图标|
